...
/////////////////////////////////////////////////////////////////////////
// SSD Heat-resistant Benchmark
// Support OS (32bit / 64bit)： Windows 2000 / XP / Vista / 8 / 8.1 / 10
/////////////////////////////////////////////////////////////////////////
    ...
    unsigned int _thread(cla_thread<bench_info>::thread_data *pdata) {
        ...
        for(;;)
        {
            *plog    << L"\r\n" << sepa
                    ...
                    << L"\r\n● " << pci->pres->getresource(IDS_LOG_PARAM).c_str() << L" " << ((int)::SendMessageW(pci->hComboThread, CB_GETCURSEL, 0L, 0L) + 1) * sector_randbuffer::RAND_GENE_MAX << pci->pres->getresource(IDS_LOG_THREAD).c_str() << L" " << rand_st.c_str() << L" " << pci->pres->getresource(IDS_LOG_RAND).c_str() << L":" << rand_type.c_str()
                    << L"\r\n" << sepa
                    << L"\r\n\r\n";
