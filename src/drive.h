...
#ifndef SORACHANCOIN_DRIVE_H
#define SORACHANCOIN_DRIVE_H
...
typedef __int64 sector_t;
const int SECTOR_SIZE_DEFAULT = 512;
const sector_t TOTAL_SECTORS_DEFAULT = (sector_t)32 * 1024 * 1024 * SECTOR_SIZE_DEFAULT; // 16GB
const int SECTORS_STEP_DEFAULT = 8;
const int NO_DRIVELETTER = -1;
const sector_t SECTORS_STEP = (sector_t)-1;
const int MAX_DRIVELETTER = 26;
const int MAX_PARTITION = 128;
const int CMD_BUFFER_SIZE = 4096;
const int CMD_SEND_LIMIT = 10;
const int DRIVE_TARGET_UNUSED = -1;
const sector_t SCAN_BEGIN_MIN_SECTOR = 1024;
...
static const wchar_t *TEMPFILE_NAME = L"__sorachan.dat";

/////////////////////////////////////////////////////////////////////////
/// Usage
/// drive_base *p = new drive_seqread, new drive_seqwrite, new drive_randomread or new drive_randomwrite.
/////////////////////////////////////////////////////////////////////////
...
{
private:
    drive_util(const drive_util &); // {}
    drive_util &operator=(const drive_util &); // {}
protected:
...
private:
    drive_handle(); // {}
    drive_handle(const drive_handle &); // {}
    drive_handle &operator=(const drive_handle &); // {}
